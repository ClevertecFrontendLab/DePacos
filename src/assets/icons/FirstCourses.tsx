export const FirstCourses = ({ width }: { width?: number }) => (
    <svg
        ...
        viewBox='0 0 24 24'
    >
        <path fill='url(#pattern0_3857_84916)' d='M0 0h24v24H0z'></path>
        <defs>
            <pattern
                id='pattern0_3857_84916'
                width='1'
                height='1'
                patternContentUnits='objectBoundingBox'
            >
                <use
                    xlinkHref='#image0_3857_84916'
                    transform='matrix(.00694 0 0 .00694 .167 .167)'
                ></use>
            </pattern>
            <image
