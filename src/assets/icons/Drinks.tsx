export const Drinks = () => (
    <svg
        ...
        viewBox='0 0 24 24'
    >
        <path fill='url(#pattern0_3857_85327)' d='M0 0h24v24H0z'></path>
        <defs>
            <pattern
                id='pattern0_3857_85327'
                width='1'
                height='1'
                patternContentUnits='objectBoundingBox'
            >
                <use
                    xlinkHref='#image0_3857_85327'
                    transform='matrix(.00781 0 0 .00781 .125 .144)'
                ></use>
            </pattern>
            <image
