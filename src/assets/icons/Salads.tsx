export const Salads = ({ width }: { width?: number }) => (
    <svg
        ...
        viewBox='0 0 24 24'
    >
        <path fill='url(#pattern0_3857_84824)' d='M0 0h24v24H0z'></path>
        <defs>
            <pattern
                id='pattern0_3857_84824'
                width='1'
                height='1'
                patternContentUnits='objectBoundingBox'
            >
                <use
                    xlinkHref='#image0_3857_84824'
                    transform='matrix(.00752 0 0 .00752 .161 .153)'
                ></use>
            </pattern>
            <image
