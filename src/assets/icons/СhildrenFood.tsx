export const ChildrenFood = ({ width }: { width?: number }) => (
    <svg
        ...
        viewBox='0 0 24 24'
    >
        <path fill='url(#pattern0_3857_85148)' d='M0 0h24v24H0z'></path>
        <defs>
            <pattern
                id='pattern0_3857_85148'
                width='1'
                height='1'
                patternContentUnits='objectBoundingBox'
            >
                <use
                    xlinkHref='#image0_3857_85148'
                    transform='matrix(.00781 0 0 .00781 .125 .125)'
                ></use>
            </pattern>
            <image
