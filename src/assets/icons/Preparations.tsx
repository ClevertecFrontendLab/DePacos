export const Preparations = () => (
    <svg
        ...
        viewBox='0 0 24 24'
    >
        <path fill='url(#pattern0_3857_85334)' d='M0 0h24v24H0z'></path>
        <defs>
            <pattern
                id='pattern0_3857_85334'
                width='1'
                height='1'
                patternContentUnits='objectBoundingBox'
            >
                <use
                    xlinkHref='#image0_3857_85334'
                    transform='matrix(.00781 0 0 .00781 .151 .147)'
                ></use>
            </pattern>
            <image
